    ...
    def _factory() -> Any:
        ...
        return monitor_cls(
            ...
            info_keywords=(
                ...
                "rage_bonus_defense_damage_pct",
                "rage_bonus_townhall_damage_pct",
                "defense_damage_pct",
                "townhall_damage_pct",
                "defenses_destroyed",
                "townhall_destroyed",
                "frozen_threat_ticks",
                "frozen_threat_damage_pct",
                "troop_damage_taken_pct",
                "splash_damage_taken_pct",
                "multi_hit_splash_damage_pct",
                "splash_cluster_risk_pct",
                "multi_hit_splash_events",
                "wall_breaker_explosions",
                "wall_breaker_damaged_wall_segments",
                "wall_breaker_destroyed_wall_segments",
                "wall_breakers_dead_without_explosion",
                "deployments",
                "deployment_unique_cells",
                "deployment_top_cell_fraction",
                "deployment_top3_cell_fraction",
                "deployment_quadrant_entropy",
                "front_damage_total_pct",
                "front_damage_second_pct",
                "front_damage_quadrant_entropy",
                ...
                "defense_damage_reward_total",
                "townhall_damage_reward_total",
                "defense_destroy_reward_total",
                "townhall_destroy_reward_total",
                "front_damage_reward_total",
                "wall_breaker_reward_total",
                "survival_reward_total",
                "wasted_spell_penalty_total",
                "unused_spell_penalty_total",
                "splash_risk_penalty_total",
                "multi_hit_splash_penalty_total",
                "deploy_crowding_penalty_total",
                "wall_breaker_death_penalty_total",
            ),
        )
        ...
        def _record_completed_episodes(self) -> None:
            ...
            for info in infos:
                ...
                records.append({
                    ...
                    "rage_bonus_defense_damage_pct": float(episode.get("rage_bonus_defense_damage_pct", info.get("rage_bonus_defense_damage_pct", 0.0))),
                    "rage_bonus_townhall_damage_pct": float(episode.get("rage_bonus_townhall_damage_pct", info.get("rage_bonus_townhall_damage_pct", 0.0))),
                    "defense_damage_pct": float(episode.get("defense_damage_pct", info.get("defense_damage_pct", 0.0))),
                    "townhall_damage_pct": float(episode.get("townhall_damage_pct", info.get("townhall_damage_pct", 0.0))),
                    "defenses_destroyed": float(episode.get("defenses_destroyed", info.get("defenses_destroyed", 0))),
                    "townhall_destroyed": float(episode.get("townhall_destroyed", info.get("townhall_destroyed", 0))),
                    "frozen_threat_ticks": float(episode.get("frozen_threat_ticks", info.get("frozen_threat_ticks", 0))),
                    "frozen_threat_damage_pct": float(episode.get("frozen_threat_damage_pct", info.get("frozen_threat_damage_pct", 0.0))),
                    "troop_damage_taken_pct": float(episode.get("troop_damage_taken_pct", info.get("troop_damage_taken_pct", 0.0))),
                    "splash_damage_taken_pct": float(episode.get("splash_damage_taken_pct", info.get("splash_damage_taken_pct", 0.0))),
                    "multi_hit_splash_damage_pct": float(episode.get("multi_hit_splash_damage_pct", info.get("multi_hit_splash_damage_pct", 0.0))),
                    "splash_cluster_risk_pct": float(episode.get("splash_cluster_risk_pct", info.get("splash_cluster_risk_pct", 0.0))),
                    "multi_hit_splash_events": float(episode.get("multi_hit_splash_events", info.get("multi_hit_splash_events", 0))),
                    "wall_breaker_explosions": float(episode.get("wall_breaker_explosions", info.get("wall_breaker_explosions", 0))),
                    "wall_breaker_damaged_wall_segments": float(episode.get("wall_breaker_damaged_wall_segments", info.get("wall_breaker_damaged_wall_segments", 0))),
                    "wall_breaker_destroyed_wall_segments": float(episode.get("wall_breaker_destroyed_wall_segments", info.get("wall_breaker_destroyed_wall_segments", 0))),
                    "wall_breakers_dead_without_explosion": float(episode.get("wall_breakers_dead_without_explosion", info.get("wall_breakers_dead_without_explosion", 0))),
                    "deployments": float(episode.get("deployments", info.get("deployments", 0))),
                    "deployment_unique_cells": float(episode.get("deployment_unique_cells", info.get("deployment_unique_cells", 0))),
                    "deployment_top_cell_fraction": float(episode.get("deployment_top_cell_fraction", info.get("deployment_top_cell_fraction", 0.0))),
                    "deployment_top3_cell_fraction": float(episode.get("deployment_top3_cell_fraction", info.get("deployment_top3_cell_fraction", 0.0))),
                    "deployment_quadrant_entropy": float(episode.get("deployment_quadrant_entropy", info.get("deployment_quadrant_entropy", 0.0))),
                    "front_damage_total_pct": float(episode.get("front_damage_total_pct", info.get("front_damage_total_pct", 0.0))),
                    "front_damage_second_pct": float(episode.get("front_damage_second_pct", info.get("front_damage_second_pct", 0.0))),
                    "front_damage_quadrant_entropy": float(episode.get("front_damage_quadrant_entropy", info.get("front_damage_quadrant_entropy", 0.0))),
                    "spell_shaping_reward_total": float(episode.get("spell_shaping_reward_total", info.get("spell_shaping_reward_total", 0.0))),
                    "objective_shaping_reward_total": float(episode.get("objective_shaping_reward_total", info.get("objective_shaping_reward_total", 0.0))),
                    "tactical_shaping_reward_total": float(episode.get("tactical_shaping_reward_total", info.get("tactical_shaping_reward_total", 0.0))),
                    ...
                    "defense_damage_reward_total": float(episode.get("defense_damage_reward_total", info.get("defense_damage_reward_total", 0.0))),
                    "townhall_damage_reward_total": float(episode.get("townhall_damage_reward_total", info.get("townhall_damage_reward_total", 0.0))),
                    "defense_destroy_reward_total": float(episode.get("defense_destroy_reward_total", info.get("defense_destroy_reward_total", 0.0))),
                    "townhall_destroy_reward_total": float(episode.get("townhall_destroy_reward_total", info.get("townhall_destroy_reward_total", 0.0))),
                    "front_damage_reward_total": float(episode.get("front_damage_reward_total", info.get("front_damage_reward_total", 0.0))),
                    "wall_breaker_reward_total": float(episode.get("wall_breaker_reward_total", info.get("wall_breaker_reward_total", 0.0))),
                    "survival_reward_total": float(episode.get("survival_reward_total", info.get("survival_reward_total", 0.0))),
                    ...
                    "splash_risk_penalty_total": float(episode.get("splash_risk_penalty_total", info.get("splash_risk_penalty_total", 0.0))),
                    "multi_hit_splash_penalty_total": float(episode.get("multi_hit_splash_penalty_total", info.get("multi_hit_splash_penalty_total", 0.0))),
                    "deploy_crowding_penalty_total": float(episode.get("deploy_crowding_penalty_total", info.get("deploy_crowding_penalty_total", 0.0))),
                    "wall_breaker_death_penalty_total": float(episode.get("wall_breaker_death_penalty_total", info.get("wall_breaker_death_penalty_total", 0.0))),
        ...
        def _log_profile_windows(self, wandb_payload: dict[str, float | int]) -> None:
            for profile, records in sorted(self._profile_episodes.items()):
                ...
                metrics = {
                    ...
                    "rage_bonus_defense_damage_pct_mean": _window_mean(records, "rage_bonus_defense_damage_pct"),
                    "rage_bonus_townhall_damage_pct_mean": _window_mean(records, "rage_bonus_townhall_damage_pct"),
                    "defense_damage_pct_mean": _window_mean(records, "defense_damage_pct"),
                    "townhall_damage_pct_mean": _window_mean(records, "townhall_damage_pct"),
                    "defenses_destroyed_mean": _window_mean(records, "defenses_destroyed"),
                    "townhall_destroyed_rate": _window_rate_at_least(records, "townhall_destroyed", 1.0),
                    "frozen_threat_ticks_mean": _window_mean(records, "frozen_threat_ticks"),
                    "frozen_threat_damage_pct_mean": _window_mean(records, "frozen_threat_damage_pct"),
                    "troop_damage_taken_pct_mean": _window_mean(records, "troop_damage_taken_pct"),
                    "splash_damage_taken_pct_mean": _window_mean(records, "splash_damage_taken_pct"),
                    "multi_hit_splash_damage_pct_mean": _window_mean(records, "multi_hit_splash_damage_pct"),
                    "splash_cluster_risk_pct_mean": _window_mean(records, "splash_cluster_risk_pct"),
                    "multi_hit_splash_events_mean": _window_mean(records, "multi_hit_splash_events"),
                    "wall_breaker_explosions_mean": _window_mean(records, "wall_breaker_explosions"),
                    "wall_breaker_damaged_wall_segments_mean": _window_mean(records, "wall_breaker_damaged_wall_segments"),
                    "wall_breaker_destroyed_wall_segments_mean": _window_mean(records, "wall_breaker_destroyed_wall_segments"),
                    "wall_breakers_dead_without_explosion_mean": _window_mean(records, "wall_breakers_dead_without_explosion"),
                    "deployments_mean": _window_mean(records, "deployments"),
                    "deployment_unique_cells_mean": _window_mean(records, "deployment_unique_cells"),
                    "deployment_top_cell_fraction_mean": _window_mean(records, "deployment_top_cell_fraction"),
                    "deployment_top3_cell_fraction_mean": _window_mean(records, "deployment_top3_cell_fraction"),
                    "deployment_quadrant_entropy_mean": _window_mean(records, "deployment_quadrant_entropy"),
                    "front_damage_total_pct_mean": _window_mean(records, "front_damage_total_pct"),
                    "front_damage_second_pct_mean": _window_mean(records, "front_damage_second_pct"),
                    "front_damage_quadrant_entropy_mean": _window_mean(records, "front_damage_quadrant_entropy"),
                    "spell_shaping_reward_mean": _window_mean(records, "spell_shaping_reward_total"),
                    "objective_shaping_reward_mean": _window_mean(records, "objective_shaping_reward_total"),
                    "tactical_shaping_reward_mean": _window_mean(records, "tactical_shaping_reward_total"),
                    ...
                    "defense_damage_reward_mean": _window_mean(records, "defense_damage_reward_total"),
                    "townhall_damage_reward_mean": _window_mean(records, "townhall_damage_reward_total"),
                    "defense_destroy_reward_mean": _window_mean(records, "defense_destroy_reward_total"),
                    "townhall_destroy_reward_mean": _window_mean(records, "townhall_destroy_reward_total"),
                    "front_damage_reward_mean": _window_mean(records, "front_damage_reward_total"),
                    "wall_breaker_reward_mean": _window_mean(records, "wall_breaker_reward_total"),
                    "survival_reward_mean": _window_mean(records, "survival_reward_total"),
                    ...
                    "splash_risk_penalty_mean": _window_mean(records, "splash_risk_penalty_total"),
                    "multi_hit_splash_penalty_mean": _window_mean(records, "multi_hit_splash_penalty_total"),
                    "deploy_crowding_penalty_mean": _window_mean(records, "deploy_crowding_penalty_total"),
                    "wall_breaker_death_penalty_mean": _window_mean(records, "wall_breaker_death_penalty_total"),
